...
var len__4818__auto___43137 = arguments.length;
var i__4819__auto___43140 = (0);
while(true){
if((i__4819__auto___43140 < len__4818__auto___43137)){
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq43051){
...
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43052,G__43053,seq43051__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__43093_SHARP_){
return (!((cljs.core.meta(p1__43093_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43108__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e43109){var _e__42099__auto__ = e43109;
return false;
}})();
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
...
}catch (e43114){var _e__42099__auto__ = e43114;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__43120 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__43121 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__43121);

try{var map__43122 = opts;
var map__43122__$1 = cljs.core.__destructure_map(map__43122);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43122__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__43120);
}});
...
var temp__5751__auto___43153 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___43153)){
var managed_print_level_43154 = temp__5751__auto___43153;
var _STAR_print_level_STAR__orig_val__43133_43155 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__43134_43156 = managed_print_level_43154;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__43134_43156);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__43124_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__43124_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__43133_43155);
}} else {
job_fn();
}
