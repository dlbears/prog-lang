...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__41307){
...
var vec__41317 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41317,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41317,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41317,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_41487 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_41487(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_41488 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_41488(a,b);
}
});
...
var fexpr__41471 = (function (){var G__41472 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41472__$1)].join('')));

}
})();
return (fexpr__41471.cljs$core$IFn$_invoke$arity$2 ? fexpr__41471.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__41471.call(null,a,b));
}));
/**
