...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_45307 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_45307(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_45312 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_45312(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45313 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45313(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45318 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45318(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45327 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45327(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45329 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45329(reader);
}
});
...
var G__45376 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__45377 = s.append(c);
c = G__45376;
s = G__45377;
continue;
}
