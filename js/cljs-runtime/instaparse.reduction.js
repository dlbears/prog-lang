...
var G__52125 = new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4611__auto__ = (function instaparse$reduction$iter__52129(s__52130){
return (new cljs.core.LazySeq(null,(function (){
var s__52130__$1 = s__52130;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__52130__$1);
if(temp__5753__auto__){
var s__52130__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__52130__$2)){
var c__4609__auto__ = cljs.core.chunk_first(s__52130__$2);
var size__4610__auto__ = cljs.core.count(c__4609__auto__);
var b__52132 = cljs.core.chunk_buffer(size__4610__auto__);
if((function (){var i__52131 = (0);
while(true){
if((i__52131 < size__4610__auto__)){
var vec__52133 = cljs.core._nth(c__4609__auto__,i__52131);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52133,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52133,(1),null);
cljs.core.chunk_append(b__52132,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)));

var G__52146 = (i__52131 + (1));
i__52131 = G__52146;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__52132),instaparse$reduction$iter__52129(cljs.core.chunk_rest(s__52130__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__52132),null);
}
} else {
var vec__52136 = cljs.core.first(s__52130__$2);
...
return cljs.core.cons((cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)),instaparse$reduction$iter__52129(cljs.core.rest(s__52130__$2)));
}
} else {
return null;
}
