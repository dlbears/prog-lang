...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_47171 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_47171(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_47172 = (function (runtime,key,spec){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_47172(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_47173 = (function (runtime,key){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_47173(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_47178 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_47178(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_47183 = (function (runtime,input,callback){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_47183(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_47185 = (function (runtime,code){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_47185(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__47165,callback){
var map__47166 = p__47165;
var map__47166__$1 = cljs.core.__destructure_map(map__47166);
var input = map__47166__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47166__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47166__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
