...
var i_47017 = (0);
while(true){
if((i_47017 < arr.length)){
(arr[i_47017] = null);

var G__47018 = (i_47017 + (1));
i_47017 = G__47018;
continue;
} else {
}
...
var i_47029 = (self__.level + (1));
while(true){
if((i_47029 <= (new_level + (1)))){
(update[i_47029] = self__.header);

var G__47030 = (i_47029 + (1));
i_47029 = G__47030;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_47032 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_47032[i]));
} else {
x__$2.forward.push((((i < links_47032.length))?(links_47032[i]):null));
}

if((i < links_47032.length)){
(links_47032[i] = x__$2);
} else {
links_47032.push(x__$2);
}
...
var i_47034 = (0);
while(true){
if((i_47034 <= self__.level)){
var links_47035 = (update[i_47034]).forward;
if((x__$1 === (((i_47034 < links_47035.length))?(links_47035[i_47034]):null))){
(links_47035[i_47034] = (x__$1.forward[i_47034]));

var G__47036 = (i_47034 + (1));
i_47034 = G__47036;
continue;
} else {
var G__47037 = (i_47034 + (1));
i_47034 = G__47037;
continue;
}
} else {
...
var G__47043 = nx;
var G__47044 = (level__$1 - (1));
x = G__47043;
level__$1 = G__47044;
continue;
} else {
var G__47045 = x;
var G__47046 = (level__$1 - (1));
x = G__47045;
level__$1 = G__47046;
continue;
}
