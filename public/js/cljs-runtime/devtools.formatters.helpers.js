...
var G__43036 = devtools.prefs.pref(v);
v = G__43036;
continue;
} else {
return v;
...
}catch (e42950){var _e__42099__auto__ = e42950;
return false;
}})();
...
}catch (e42956){var _e__42099__auto__ = e42956;
return false;
}})();
...
}catch (e42958){var _e__42099__auto__ = e42958;
return false;
}}
}
});
...
var vec__42968 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42968,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42968,(1),null);
...
return cljs.core.some((function (p1__43008_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__43008_SHARP_);
}),template);
});
