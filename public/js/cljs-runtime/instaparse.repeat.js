...
var vec__53673 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53673,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53673,(1),null);
...
var vec__53676 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53676,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53676,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__53680 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53680,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53680,(1),null);
...
var G__53955 = cljs.core.next(parses__$1);
parses__$1 = G__53955;
continue;
}
...
var G__53693 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__53694 = G__53693;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53694,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53694,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53694,(2),null);
var selection = vec__53694;
...
var vec__53700 = G__53693__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53700,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53700,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53700,(2),null);
var selection__$1 = vec__53700;
...
var G__53964 = cljs.core.long$(end__$1);
var G__53965 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__53966 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__53964;
parses__$1 = G__53965;
G__53693__$1 = G__53966;
continue;
...
var G__53794 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__53801 = G__53794;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53801,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53801,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53801,(2),null);
var selection = vec__53801;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__53794__$1 = G__53794;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__53812 = G__53794__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53812,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53812,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53812,(2),null);
var selection__$1 = vec__53812;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__53969 = cljs.core.long$(end__$1);
var G__53970 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__53971 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__53969;
parses__$1 = G__53970;
G__53794__$1 = G__53971;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__53867 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__53868 = G__53867;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53868,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53868,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53868,(2),null);
var selection = vec__53868;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__53867__$1 = G__53867;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__53874 = G__53867__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53874,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53874,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53874,(2),null);
var selection__$1 = vec__53874;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__53977 = cljs.core.long$(end__$1);
var G__53978 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__53979 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__53977;
parses__$1 = G__53978;
G__53867__$1 = G__53979;
continue;
...
if(cljs.core.truth_((function (){var fexpr__53900 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__53900.cljs$core$IFn$_invoke$arity$1 ? fexpr__53900.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__53900.call(null,output_format));
})())){
} else {
...
if(cljs.core.truth_((function (){var or__4212__auto__ = cljs.core.empty_QMARK_(header_results);
if(or__4212__auto__){
...
if(cljs.core.not((function (){var and__4210__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207));
if(and__4210__auto__){
var and__4210__auto____$1 = (function (){var G__53940 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__53939 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__53939.cljs$core$IFn$_invoke$arity$1 ? fexpr__53939.cljs$core$IFn$_invoke$arity$1(G__53940) : fexpr__53939.call(null,G__53940));
})();
