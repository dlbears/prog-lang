...
var o42477 = temp__5751__auto__;
var temp__5751__auto____$1 = (o42477["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o42478 = temp__5751__auto____$1;
return (o42478["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__42080__auto__ = f;
return (o__42080__auto__["toString"]).call(o__42080__auto__);
} else {
return "";
}
...
try{var o__42080__auto___42896 = t;
(o__42080__auto___42896["cljs$lang$ctorPrWriter"]).call(o__42080__auto___42896,t,writer);
}catch (e42515){var __42897 = e42515;
}
...
var char_code = (function (){var o__42080__auto__ = (new String(char$));
return (o__42080__auto__["charCodeAt"]).call(o__42080__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__42080__auto__ = String;
return (o__42080__auto__["fromCharCode"]).call(o__42080__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__42528 = num_code;
switch (G__42528) {
case (1):
return (185);
...
var o__42080__auto__ = String;
return (o__42080__auto__["fromCharCode"]).call(o__42080__auto__,superscript_code);
});
/**
...
}catch (e42535){var _e__42099__auto__ = e42535;
return false;
}})())){
...
var vec__42536 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42536,(0),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var o42556 = temp__5751__auto__;
var temp__5751__auto____$1 = (o42556["dependencies_"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o42557 = temp__5751__auto____$1;
return (o42557["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__42564){
var vec__42566 = p__42564;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42566,(0),null);
...
var G__42913 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__42914 = cljs.core.butlast(remaining_tokens);
name_tokens = G__42913;
remaining_tokens = G__42914;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq42560){
var G__42562 = cljs.core.first(seq42560);
var seq42560__$1 = cljs.core.next(seq42560);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42562,seq42560__$1);
}));
...
var vec__42578 = cljs.core.split_with((function (p1__42577_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__42577_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42578,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42578,(1),null);
...
var vec__42601 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42601,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42601,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__42920 = cljs.core.rest(remaining_tokens);
var G__42921 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__42920;
name_tokens = G__42921;
continue;
} else {
...
var vec__42624 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42624,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42624,(1),null);
var vec__42627 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42627,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42627,(1),null);
var vec__42630 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42630,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42630,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42630,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42630,(3),null);
...
var vec__42659 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42659,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42659,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42659,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42659,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42659,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42659,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__42675 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42675,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42675,(1),null);
var vec__42678 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
...
var G__42965 = (arity + (1));
var G__42966 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__42704){
var vec__42705 = p__42704;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42705,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42705,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__42716_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42717_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__42717_SHARP_);
}),sorted_infos);
...
var args__4824__auto__ = [];
var len__4818__auto___42979 = arguments.length;
var i__4819__auto___42980 = (0);
while(true){
if((i__4819__auto___42980 < len__4818__auto___42979)){
args__4824__auto__.push((arguments[i__4819__auto___42980]));

var G__42981 = (i__4819__auto___42980 + (1));
i__4819__auto___42980 = G__42981;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__42720){
var vec__42721 = p__42720;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42721,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq42718){
var G__42719 = cljs.core.first(seq42718);
var seq42718__$1 = cljs.core.next(seq42718);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42719,seq42718__$1);
}));
...
var map__42750 = options;
var map__42750__$1 = cljs.core.__destructure_map(map__42750);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42750__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42750__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42750__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42750__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__42751 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42751,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42751,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42751,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42751,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42751,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42751,(5),null);
...
var o__42080__auto__ = f;
return (o__42080__auto__["getBasis"]).call(o__42080__auto__);
});
/**
...
}catch (e42764){var _e__42099__auto__ = e42764;
...
var G__43005 = (obj[cljs.core.first(path)]);
var G__43006 = cljs.core.rest(path);
obj = G__43005;
path = G__43006;
continue;
} else {
...
var _STAR_ = (function (accum,p__42842){
var vec__42845 = p__42842;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42845,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42845,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__42853){
var vec__42855 = p__42853;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42855,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42855,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42855,(2),null);
...
var post_process = (function (p__42880){
var vec__42881 = p__42880;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42881,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42881,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42867_SHARP_){
return (obj[cljs.core.first(p1__42867_SHARP_)]);
}),sorted_matches);
