...
var G__55968 = o;
goog.object.set(G__55968,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__55990__delegate = function (args){
...
while (G__55991__i < G__55991__a.length) {G__55991__a[G__55991__i] = arguments[G__55991__i + 0]; ++G__55991__i;}
  args = new cljs.core.IndexedSeq(G__55991__a,0,null);
} 
return G__55990__delegate.call(this,args);};
G__55990.cljs$lang$maxFixedArity = 0;
G__55990.cljs$lang$applyTo = (function (arglist__55992){
var args = cljs.core.seq(arglist__55992);
return G__55990__delegate(args);
});
...
var G__55973 = o;
goog.object.set(G__55973,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__55993__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__55993 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__55994__i = 0, G__55994__a = new Array(arguments.length -  0);
while (G__55994__i < G__55994__a.length) {G__55994__a[G__55994__i] = arguments[G__55994__i + 0]; ++G__55994__i;}
  args = new cljs.core.IndexedSeq(G__55994__a,0,null);
} 
return G__55993__delegate.call(this,args);};
G__55993.cljs$lang$maxFixedArity = 0;
G__55993.cljs$lang$applyTo = (function (arglist__55995){
var args = cljs.core.seq(arglist__55995);
return G__55993__delegate(args);
});
G__55993.cljs$core$IFn$_invoke$arity$variadic = G__55993__delegate;
return G__55993;
})()
;
} else {
...
var G__55974 = props;
var G__55974__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55974,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__55974);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55974__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4212__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__55975 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55975,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__55975;
}
})(),id_class);
...
var G__55976 = (cljs.core.count(argv) - first_child);
switch (G__55976) {
case (0):
...
var vec__55977 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55977,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55977,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55977,(2),null);
...
var temp__5757__auto___56006 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___56006 == null)){
} else {
var key_56007 = temp__5757__auto___56006;
(jsprops.key = key_56007);
}
...
var temp__5757__auto___56008 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___56008 == null)){
} else {
var key_56009 = temp__5757__auto___56008;
(jsprops.key = key_56009);
}
...
var temp__5757__auto___56010 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___56010 == null)){
} else {
var key_56011 = temp__5757__auto___56010;
(jsprops.key = key_56011);
}
...
var temp__5757__auto___56013 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___56013 == null)){
} else {
var key_56014 = temp__5757__auto___56013;
(jsprops.key = key_56014);
}
...
var temp__5757__auto___56015 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___56015 == null)){
} else {
var key_56016 = temp__5757__auto___56015;
(jsprops.key = key_56016);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55980_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__55980_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__55981 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55981,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55981,(1),null);
...
break;
default:
var G__56020 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__56021 = compiler;
v = G__56020;
compiler = G__56021;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template55987 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template55987 = (function (opts,id,fn_to_element,parse_fn,meta55988){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta55988 = meta55988;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template55987.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55989,meta55988__$1){
var self__ = this;
var _55989__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template55987(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta55988__$1));
}));

(reagent.impl.template.t_reagent$impl$template55987.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55989){
var self__ = this;
var _55989__$1 = this;
return self__.meta55988;
}));

(reagent.impl.template.t_reagent$impl$template55987.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template55987.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template55987.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template55987.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template55987.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template55987.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta55988","meta55988",-236922802,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template55987.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template55987.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template55987");

(reagent.impl.template.t_reagent$impl$template55987.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"reagent.impl.template/t_reagent$impl$template55987");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template55987.
 */
reagent.impl.template.__GT_t_reagent$impl$template55987 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template55987(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta55988){
return (new reagent.impl.template.t_reagent$impl$template55987(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta55988));
});

}

return (new reagent.impl.template.t_reagent$impl$template55987(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
